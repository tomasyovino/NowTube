...
export const categories = [
  ...
  { name: 'Películas', icon: <OndemandVideoIcon />, },
  { name: 'Videojuegos', icon: <SportsEsportsIcon />, },
  { name: 'En vivo', icon: <LiveTvIcon />, },
...
export const demoChannelTitle = 'NowTube Channel Title';
export const demoVideoTitle = 'Lorem ipsum dolor sit amet, consectetur adipiscing elements';
